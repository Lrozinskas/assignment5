...
#             print(f"  - {video['title']}")
#
# def video_length_preference_analysis(watch_history):
#     video_lengths = [entry['duration'] / 60 for entry in watch_history]
#
#     # Plotting the distribution of video lengths
#     plt.figure(figsize=(10, 6))
#     sns.histplot(video_lengths, bins=20, kde=True)
...
#
#     video_lengths = [entry['duration'] / 60 for entry in watch_history]
#     video_length_preference_analysis(video_lengths)
#
